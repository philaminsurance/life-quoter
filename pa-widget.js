...
(function () {
  ...
  ".pa-foot{font-size:11px;color:var(--muted);margin-top:16px;line-height:1.5;text-align:center;}"+".pa-wrap{--navy:#00267C;--gold:#FFCE47;font-family:'Metrophobic',Arial,sans-serif;}.pa-title,.pa-cov,.pa-hero-p,.pa-card-name,.pa-card-price,.pa-soon-t{font-family:'Inter',sans-serif;font-weight:800;}.pa-tab,.pa-mini,.pa-cta{font-family:'Dosis',sans-serif;letter-spacing:.03em;}.pa-mini,.pa-cta{border-radius:0;color:#033537;}.pa-tg,.pa-tab,.pa-mini,.pa-cta{box-shadow:none!important;text-transform:none!important;text-shadow:none!important;height:auto!important;min-height:0!important;width:auto!important;white-space:normal!important;line-height:1.25!important;font-family:'Dosis',sans-serif!important;}.pa-tg{background:var(--card)!important;color:var(--muted)!important;border:1px solid var(--line)!important;border-radius:8px!important;}.pa-tg.is-on{background:var(--navy)!important;color:#fff!important;border-color:var(--navy)!important;}.pa-tab{background:transparent!important;color:var(--muted)!important;border-radius:7px!important;}.pa-tab.is-on{background:var(--navy)!important;color:#fff!important;}.pa-mini,.pa-cta{background:var(--gold)!important;color:#033537!important;border:0!important;border-radius:4px!important;}";
